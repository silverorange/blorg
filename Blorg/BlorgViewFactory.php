 ...
 *
 * // get a new post view
 * $post_view = BlorgViewFactory::get($this->app, 'post');
 *
 * // register a new view class for posts
 * BlorgViewFactory::registerView('post', 'MyPostView');
 *
 * // create a new post view of class 'MyPostView'
 * $post_view = BlorgViewFactory::get($this->app, 'post');
 *
 * ?>
 * </code>
 ...
 * '<code>Blorg/views</code>' is included by default. Search paths can be added
 * and removed using the {@link BlorgViewFactory::addPath()} and
 * {@link BlorgViewFactory::removePath()} methods.
 *
 * @package   Blörg
...
class BlorgViewFactory extends SwatObject
{
	 ...
	 * @var array
	 */
	private static $search_paths = array('Blorg/views');
	 ...
	 * '<code>Blorg/views</code>' is included by default.
	 *
