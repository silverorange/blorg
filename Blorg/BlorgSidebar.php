 ...
 * class 'blorg-sidebar-gadget'.
 *
 * The first gadget will also have the special CSS class
 * 'blorg-sidebar-gadget-first' applied. Similarly, the last gadget will also
 * have the special CSS class 'blorg-sidebar-gadget-last' applied.
 *
 * @package   Blörg
...
class BlorgSidebar extends SwatWidget implements SwatUIParent
{
	 ...
	 * 'blorg-sidebar-gadget'.
	 *
	 * The first gadget will have the special CSS class
	 * 'blorg-sidebar-gadget-first' applied. Similarly, the last gadget will
	 * have the special CSS class 'blorg-sidebar-gadget-last' applied.
	 */
	public function display()
	{
